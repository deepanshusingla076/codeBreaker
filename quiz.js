document.addEventListener("DOMContentLoaded", () => {
    let currentPage = 1; // Start on page 20 (or adjust as needed)
    const totalPages = 20; // Update to reflect the total number of pages in your quiz
    ...
    document.querySelectorAll("form").forEach(form => {
        form.addEventListener("submit", (e) => {
            ...
            replyDiv.style.padding = "10px 10px 15px 10px";
